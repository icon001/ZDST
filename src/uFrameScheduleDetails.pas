...
type
  TframeScheduleDetails = class(TFrame)
...
procedure TframeScheduleDetails.formCreate;
var
  i : integer;
  chkbox : TCheckBox;
begin
...
procedure TframeScheduleDetails.FormInitiailize;
var
  I: Integer;
  Column: TColumn;
begin
...
procedure TframeScheduleDetails.GridCreate;
